...
class UserProfile(WebsiteGenerator):
    ...
    from fossunited.user_profiles.doctype.foss_user_profile_education.foss_user_profile_education import (
    FOSSUserProfileEducation,
)
from fossunited.user_profiles.doctype.foss_user_profile_work_experience.foss_user_profile_work_experience import (
    FOSSUserProfileWorkExperience,
)
from fossunited.user_profiles.doctype.foss_user_projects.foss_user_projects import (
    FOSSUserProjects,
)
from fossunited.user_profiles.doctype.foss_user_skill_multiselect.foss_user_skill_multiselect import (
