...
2. While most people view open source primarily as code, we encourage you to look beyond software and align your efforts with the broader ideology of the [Digital Commons](https://en.wikipedia.org/wiki/Digital_commons).

3. Ask questions directly rather than asking permission to ask. See [https://dontasktoask.com/](https://dontasktoask.com) for a detailed explanation. This saves time for everyone involved.
