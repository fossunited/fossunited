# How to Send Emails via dashboard

## Getting Started

First, log in to [fossunited.org](https://fossunited.org). Once you're in, click on your profile picture at the top right corner to access your dashboard, or simply go to [fossunited.org/dashboard](https://fossunited.org/dashboard).
![Dashboard on fossunited](./assets/manage-chapter.png)

## Finding the mailing section
...
Pick the chapter you want to send emails for. Once you're in, you'll see a menu on the left with options like Details, Events, Members, and Mailing. Select "Mailing".
...
If you need to attach files, click the "+ Attachment" button below the message box. You can upload PDF, JPG, PNG, SVG, or JPEG files. Just make sure each file is under 10MB.
...
That's it! Your email will go out to all the recipients you selected.
