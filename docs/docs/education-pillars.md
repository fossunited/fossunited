...
**Replace simulation tools:** Use the [tools table](education-foss-alternatives.md) to find FOSS equivalents for your branch's most common proprietary software.
...
**Start a FOSS Cell:** A small group of students with a written charter, a faculty advisor, and a clear purpose. FOSS United has a template charter and can connect your cell to the broader national community.
...
> **FOSS United can help:** FOSS Cells, city communities, IndiaFOSS, FOSS Hack and Season of Commites are all active programs. Your institution can plug into any of these with a single email to foundation@fossunited.org.
---
