...
> `https://fossunited.org/u/<username>`
...
1. Talks Given
2. CFP Proposed
3. Chapter Volunteer-ship
4. Events Attended
5. Hackathon Attended

![Profile Activity page](./assets/profile-activity.png)

We also plan to improve activity part of users, do share us your thoughts by [opening discussion](https://github.com/fossunited/fossunited/issues/new).
