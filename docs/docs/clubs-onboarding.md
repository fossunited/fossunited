# FOSS Club Onboarding

If you haven't already, [book a call with our team](https://cal.com/team/fossunited/learners-program) to discuss the FOSS Club program. This is a great opportunity for us to introduce you to FOSS United and learn more about your journey.
...
- **Obtain Permission:** Secure an official permission letter from your college to start the club and share it with us at [clubs@fossunited.org](mailto:clubs@fossunited.org).

- **Submit Application:** Fill out the [FOSS Clubs application form](https://fossunited.org/clubs/start-a-club/new).
...
- **Forum Presence:** Create a "Club Intro" thread on the [FOSS United Forum](https://forum.fossunited.org/). This serves as a dedicated space to showcase your work to the broader community. You can refer to the [Mukti (Bengaluru) updates thread](https://forum.fossunited.org/t/mukti-a-foss-club-in-bangalore-updates-thread/2522/23) as an example.
