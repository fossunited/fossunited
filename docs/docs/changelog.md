...
- **[#1147](https://github.com/fossunited/fossunited/pull/1147)** Add QRcode scanner for Ticket Check-ins
...
- 🎉 [@agriyakhetarpal](https://github.com/agriyakhetarpal) made their first contribution:
  - [#1142](https://github.com/fossunited/fossunited/pull/1142): Add Zulip logo for chapters
...
- 🎉 [@arunppsg](https://github.com/arunppsg) made their first contribution:
  - [#1167](https://github.com/fossunited/fossunited/pull/1167): Add more docs
