  ...
  <div v-if="submissions.data && cfp_form.data" class="px-4 py-8 md:p-8 flex flex-col gap-4">
    <div class="flex flex-col gap-4 my-2">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        <Card :title="`Total Submissions: ${submissions.data.length}`" />
      </div>
    </div>
    ...
    >
      <template #body-content>
        ...
        <div v-else class="flex flex-col gap-6">
          <div class="flex flex-col gap-4">
            <div
              class="flex flex-col md:flex-row justify-between items-baseline mb-1 pb-2 border-b"
            >
              <div class="text-lg font-semibold">
                Status:
                <span
                  :class="
                    selected_row_data.doc.status == 'Approved'
                      ? 'text-green-600'
                      : selected_row_data.doc.status == 'Rejected'
                        ? 'text-red-600'
                        : 'text-orange-500'
                  "
          ...
          <div class="flex flex-col gap-4">
            ...
            <div class="flex flex-col mb-4 gap-2">
              ...
              <div v-if="selected_row_data.doc.picture_url">
                ...
                <div class="flex flex-col gap-2">
                  <img
                    :src="selected_row_data.doc.picture_url"
                    alt="Submitted Image"
                    class="w-32 object-cover aspect-square rounded-sm"
                  />
                  <Button
                    class="w-fit"
                    size="md"
