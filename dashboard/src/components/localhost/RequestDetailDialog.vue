    ...
    <div class="grid grid-cols-2 gap-4 text-base">
        ...
        <div class="flex gap-2">
            ...
            <div class="flex flex-col gap-1">
                ...
                <div @click="redirectToRoute(participant.profile_route)" class="text-sm text-green-600 hover:underline hover:cursor-pointer" v-if="participant.profile_username">{{ participant.profile_username }}</div>
            </div>
        </div>
        <div>
        ...
        <div class="flex flex-col gap-1">
            ...
            <div v-if="participant.project_title" @click="redirectToRoute(participant.project_route)" class="hover:underline hover:cursor-pointer flex items-center gap-1">{{ truncateStr(participant.project_title, 20) }}<FeatherIcon name="external-link" class="w-4 h-4 inline-block"/></div>
