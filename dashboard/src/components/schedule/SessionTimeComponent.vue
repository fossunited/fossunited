<template>
  <div class="px-6 py-4 flex flex-col items-center  gap-2 border border-gray-500 bg-white h-fit">
    ...
    <div class="flex text-xs items-center gap-2 uppercase text-gray-600 divide-x-2 divide-gray-400" v-if="session.category !== 'Break'">
...
function getFormattedTime(time) {
  return dayjs(`1970-01-01 ${time}`).format('hh:mm A');
}
</script>
